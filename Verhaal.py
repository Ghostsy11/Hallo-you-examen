            ...
            if Stukje5keuzes == 2:
                ...
                if Stukje7keuzes == 2:
                    ...
                    if Stukje9keuzes == 1 or 2:
                        os.system("cls")
                        print("U bent nog steeds op de juiste weg maak geen zorgen, op passen bij de volgende opties")
                        ...
                        if Stukje10keuzes == 2:
                            ...
                            if Stukje11keuzes == 2:
                                ...
                                ask5 = input("Wilt u nog een keer spelen? ja of nee : \n")                                               
                                    if ask5 == "nee":    
                                        print("Helaas niet:" )
                                        quit
                                ...
                                if Stukje12keuzes == 2:
                                    ...
                                    time.sleep(3)
                                    print("Ik denk had mij kans gemist naar Europa en ik bleef in Turkije! Doodlopende einde Onbekende toekomst... ")
                                    ask4 = input("Wilt u nog een keer spelen? ja of nee : \n")                                               
                                        if ask4 == "nee":    
                                            print("Helaas niet:" )
                                            quit
                                    ...
                                    if Stukje18keuzes == 2:                                                                     
                                        ...
                                        print("Als ik de straf had gedaan, Ik zou nog 3 maanden wachten en ik zei geen licht dus ik had waarschijnlijk besloten om mijn toekomst in Griekenland te bouwen.\n Onbekend Einde  ")
                                        time.sleep(3)
                                        ask3 = input("Wilt u nog een keer spelen? ja of nee : \n")                                               
                                            if ask3 == "nee":    
                                                print("Helaas niet:" )
                                                quit
                                        ...
                                        if Stukje19keuzes == 2:
                                            ...
                                            ask2 = input("Wilt u nog een keer spelen? ja of nee : \n")                                               
                                                if ask2 == "nee":    
                                                    print("Helaas niet:" )
                                                    quit
                                            ...
                                            print("            \\                      ")
                                            print("             \\                     ")
                                            ask1 = input("Wilt u nog een keer spelen? ja of nee : \n")                                               
                                            if ask1 == "nee":    
                                                print("Helaas niet:" )
                                                quit
                                ...
                                if Stukje13keuzes == 2:
                                    ...
                                    if Stukje18keuzes == 2:
                                        ...
                                        if Stukje19keuzes == 2:
                                            ...
                                            time.sleep(3)
                                            print(" jij hebt zowel punten: " + str(Score))
                                            ask00 = input("Wilt u nog een keer spelen? ja of nee : \n")                                               
                                                if ask00 == "nee":    
                                                    print("Helaas niet:" )
                                                    quit
                                        elif Stukje19keuzes == 1:
