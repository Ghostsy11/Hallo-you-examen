...
while True:
    ...
    antwoord_1 = input(
        "Als u met hulp optie wil tijpt u AUB ja anders nee :").lower()
    os.system("cls")
    if antwoord_1 == "ja":
        ...
        if Stukje1keuzes == 2:
            ...
            if Stukje5keuzes == 2:
                ...
                ask88 = input("Wilt u nog een keer spelen? ja of nee : \n")
                if ask88 == "nee":
                    print("Helaas niet:")
                    quit
                ...
                if Stukje7keuzes == 2:
                    ...
                    ask7 = input("Wilt u nog een keer spelen? ja of nee : \n")
                    if ask7 == "nee":
                        print("Helaas niet:")
                        quit
        ...
        if Stukje4keuzes == 1 or 2:
            ...
            if Stukje5keuzes == 2:
                ...
                if Stukje7keuzes == 2:
                    ...
                    print(" jij hebt zowel punten: " + str(Score))
                    ask6 = input("Wilt u nog een keer spelen? ja of nee : \n")
                    if ask6 == "nee":
                        print("Helaas niet:")
                        quit
                elif Stukje7keuzes == 1:
